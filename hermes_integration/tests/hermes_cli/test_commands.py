...
class TestSubcommands:
    ...
    def test_mission_lifecycle_actions_are_all_discoverable(self):
        assert {
            "inspect", "prepare", "start", "pause", "resume", "verify",
            "approve", "commit", "cancel", "rollback", "reconcile",
        } <= set(SUBCOMMANDS["/mission"])
