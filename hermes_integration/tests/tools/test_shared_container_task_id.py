...
def test_mission_worker_uses_its_exact_task_container(monkeypatch):
    monkeypatch.setenv("HERMES_KANBAN_TASK", "t_mission123")
    monkeypatch.setenv("HERMES_MISSION_POLICY", '{"mission_id":"m_123"}')
    assert terminal_tool._resolve_container_task_id("tool-call-id") == "t_mission123"
