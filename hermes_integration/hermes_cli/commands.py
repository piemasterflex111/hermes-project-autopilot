...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("kanban", "Multi-profile collaboration board (tasks, links, comments)",
               ...
               busy_policy="dispatch"),
    CommandDef("mission", "Run evidence-gated engineering missions",
               "Tools & Skills", args_hint="[subcommand]",
               subcommands=("create", "list", "show", "inspect", "prepare", "task-add",
                            "plan-auto", "plan-finish", "start", "pause", "resume",
                            "evidence-add", "verify", "verdict", "approve", "commit",
                            "cancel", "rollback", "reconcile"),
               busy_policy="dispatch"),
...
#   - platform: low-frequency per-platform recovery controls remain available
#     as /hermes platform. The native slot is assigned to the Project Autopilot
#     /mission surface; /platforms remains native for routine status checks.
