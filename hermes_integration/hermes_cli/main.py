...
def cmd_mission(args):
    """Restart-safe, evidence-gated engineering missions."""
    from hermes_cli.missions import mission_command
...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "gui", "desktop", "kanban", "mission", "login", "logout", "logs", "lsp", "mcp", "memory", "migrate", "moa",
...
def main():
    ...
    # =========================================================================
    # mission command — restart-safe project autopilot
    # =========================================================================
    from hermes_cli.missions import build_parser as _build_mission_parser
