    ...
    try:
        ...
        with ExitStack() as _locks:
            ...
            if mode == "replace":
                ...
                result = file_ops.patch_v4a(_mission_patch_operation(patch, task_id))
            else:
