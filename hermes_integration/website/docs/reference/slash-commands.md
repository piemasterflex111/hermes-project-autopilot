...
| `/mission <action>` | Create and operate restart-safe Project Autopilot missions. Mirrors `hermes mission` for planning, execution, verification, approval, local commit, recovery, and rollback. |
