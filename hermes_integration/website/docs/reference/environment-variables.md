...
| `HERMES_MISSION_POLICY` | Internal dispatcher-injected JSON binding for a Project Autopilot worker. File and terminal tools use it to enforce mission role, worktree, allowed paths, and terminal backends. Do not set manually. |
