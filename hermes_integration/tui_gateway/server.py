    ...
    **_kwargs,
    ...
    if event_type == "message.reset":
        _emit(
            "message.reset",
            sid,
            {"reason": str(_kwargs.get("reason") or "provider_retry")},
        )
        return
